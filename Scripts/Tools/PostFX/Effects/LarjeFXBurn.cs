...
[CreateAssetMenu(menuName = "Larje/Core/PostFX/Burn Effect", fileName = "LarjeFX_Burn")]
public class LarjeFXBurn : LarjePostFX
{
    ...
    public new class Processor : LarjePostFX.Processor
    {
        ...
        public Processor(LarjeFXBurn config)
        {
            _config = config;
