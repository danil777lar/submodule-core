...
[CreateAssetMenu(menuName = "Larje/Core/PostFX/Menu Effect", fileName = "LarjeFX_Menu")]
public class LarjeFXMenu : LarjePostFX
{
    ...
    public new class Processor : LarjePostFX.Processor
    {
        ...
        public Processor(LarjeFXMenu config)
        {
            _config = config;
